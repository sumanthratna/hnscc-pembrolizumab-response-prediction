...
def load_fov_with_quench_subtraction(
    ...
    for marker in marker_panel.markers:
        ...
        stained_filename = f"{base_id}_cycle{marker.cycle}_w{marker.channel}_{fov_id}_t1.TIF"
        stained_path = f"{bucket}/{prefix}/{sample_id}/cycle{marker.cycle}/{stained_filename}"
